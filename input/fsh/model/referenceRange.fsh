...
* sex 0..1 CodeableConcept "Patient sex" "Patient sex"
...
* sourceLink 0..1 url "Reference range source link URL" "Reference range source link URL"
* sourceDescription 0..1 string "Reference range source description" "Reference range source description"
