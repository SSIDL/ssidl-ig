Profile: SsidlSpecimenDefinitionBW
Parent: SpecimenDefinition
Id: ssidl-specimenDefinition-BW
Title: "Czynniki przedanalityczne (SSIDL Baza wiedzy)"
...
* useContext.valueCodeableConcept = #BW
* jurisdiction 0..0
* purpose 0..0
* copyright 0..0
* copyrightLabel 0..0
...
* typeCollected.coding from SsidlMaterialTypeVS
